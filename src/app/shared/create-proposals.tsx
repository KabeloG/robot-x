...
function ActionFields() {
  ...
  let [cripticTokenAction, setRobotXTokenAction] = useState(
        ...
        <div className="flex items-start gap-4 xs:gap-3 xl:gap-4">
          ...
          <div>
            ...
            <p className="leading-[1.8] text-gray-600 dark:text-gray-400">
              In order to submit a proposal you must have at least 10,000 RobotX
              tokens <br className="hidden xl:inline-block" /> delegated to you{' '}
              <a
                target="_blank"
